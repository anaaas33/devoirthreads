    ...
    public void run() {
        synchronized (mutex) {
            try {
                ...
                ObjectNode rootNode = (ObjectNode) mapper.readTree(new File("/Users/macm2/DevoirThread-main/Files/input.json"));
                ...
                mapper.writerWithDefaultPrettyPrinter().writeValue(new File("/Users/macm2/DevoirThread-main/Files/output.json"), outputRoot);

                ObjectNode errorRoot = mapper.createObjectNode();
                errorRoot.set("orders", mapper.valueToTree(invalidOrders));
                mapper.writerWithDefaultPrettyPrinter().writeValue(new File("/Users/macm2/DevoirThread-main/Files/error.json"), errorRoot);
